...
async def get_assets_by_owner(request: Request, user=Depends(auth.auth_user_wrapper), db: Session = Depends(get_session), owner_id: int=0):
...
async def get_all_assets_by_owner_with_files(request: Request, user=Depends(auth.auth_user_wrapper), db: Session = Depends(get_session), owner_id: int=0):
...
async def get_single_asset(request: Request, user=Depends(auth.auth_user_wrapper), db: Session = Depends(get_session), asset_id: int = 0):
...
async def get_single_asset_with_file(request: Request, user=Depends(auth.auth_user_wrapper), db: Session = Depends(get_session), asset_id: int = 0):
...
async def get_all_asset_files(request: Request, user=Depends(auth.auth_user_wrapper), db: Session = Depends(get_session), asset_id: int=0):
...
async def get_single_asset_file(request: Request, user=Depends(auth.auth_user_wrapper), db: Session = Depends(get_session), file_id: int = 0):
